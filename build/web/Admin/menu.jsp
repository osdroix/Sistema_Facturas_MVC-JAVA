...
DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");
   ...
   <%
    ...
    if (sesion.getAttribute("user")!=null){
        ...
        ArrayList<facturas> fac = new ArrayList();
        us=crud.getUsu(u.getCorre_usu());
        fac = crud.getfac(u.getId_usu());
                             ...
                             <center>
                                 <input class="fecha" readonly  type="text" value="<%out.println(f.getFecha_fac());%>" /><br>
                                    ...
                                    <div class="party-flex">
                                                <a id="btn" class="btn btn-info" href="<%out.println("/Facturas/Admin/editar.jsp?id="+f.getId_fac()+"");%>">Editar</a>
                                                <a id="btn" class="btn btn-danger" href="<%out.println("/Facturas/Admin/eliminar.jsp?id="+f.getId_fac()+"");%>">Eliminar</a>
                                     </div>   
                    </div>
                      <%  }
                    }else{
  ...
  <div class="overlay" id="overlay">
    <div class="popup" id="popup">
        ...
        <h2 class="texturas">Nueva Factura</h2><hr>
             <form action="/Facturas/Admin/validar.jsp" method="POST">
                 <center>
