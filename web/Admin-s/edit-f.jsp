...
<body class="login">
    <article class="sub">
        <div class="capsula-fac">
            ...
            <a class="btn btn-link" href="/Facturas/Admin-s/menu.jsp">Regresar</a>
            </div>
            <h2 class="fecha">Calculo de viáticos</h2>
            <hr>
             <form action="/Facturas/Modulador?accion=Editar_fac_e"  method="POST">
                 <center>
                            <input class="fecha" readonly type="text" value="<%out.println(id);%>"  name="id"/><!Es la id de usuario es 1 para identificar de quien es la factura>
                     ...
                     <input class="form-control"  readonly  type="text" value="<%out.println(nom);%>" name="nom"><br>
                        ...
                        <hr>
                            <button type="submit"  class="btn btn-info btn-block" name="btn">Dar de alta la modificación</button>
             </form>
        </div>
    </article>
    </body>
